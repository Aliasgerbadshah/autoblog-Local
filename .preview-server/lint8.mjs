...
$files = ['index.php','includes/database.php','includes/publishers.php','includes/maker.php','includes/content_engine.php','includes/helpers.php','cron/daily.php','cron/backlink-30min.php'];
foreach ($files as $f) {
